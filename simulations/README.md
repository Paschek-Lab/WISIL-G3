...
This directory contains input files for molecular dynamics simulations of an equimolar mixture of $\mathrm{[Li][NTf_2]}$ and triglyme (G3), as well as systems that include various additional amounts of water. All simulations were performed using **GROMACS 2019.6**.
...
The systems are labeled according to the molar ratios of their components. The folders [1_1_0](1_1_0/) and [1_1_1](1_1_1/) for example correspond to mixtures of $\mathrm{[Li][NTf_2]:G3:H_2O}$ with ratios 1:1:0 and 1:1:1, respectively.
